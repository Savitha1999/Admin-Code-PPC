...
{/* pasttt */}
          ...
          {/* <div className="col-md-6 mb-3">
            ...
            <div>
              <label className="form-check-label me-2">
                <input type="radio" name="cornerPlot" value="yes" className="form-check-input radioform" /> Yes
              </label>
              <label className="form-check-label">
                <input type="radio" name="cornerPlot" value="no" className="form-check-input radioform" /> No
              </label>
            </div>
          </div> */}
          <div className="col-md-6 mb-3">
          ...
          {/* <div className="col-md-6 mb-3">
            ...
            <div>
              <label className="form-check-label me-2">
                <input type="radio" name="possessionStatus" value="Under Construction" className="form-check-input radioform" /> Under Construction
              </label>
              <label className="form-check-label">
                <input type="radio" name="possessionStatus" value="Ready to Move" className="form-check-input radioform" /> Ready to Move
              </label>
            </div>
          </div> */}
          {/* <div className="col-md-6 mb-3">
            ...
            <div className="d-flex">
              <select name="availableMonth" className="form-select me-2 rounded-0">
              ...
              <select name="availableYear" className="form-select rounded-0">
    ...
    <form onSubmit={handleSubmit} className="propertyform w-100" style={{ maxWidth: '500px' }}>
     ...
     <div className="mb-3">
      ...
      {/* <div className="mb-3">
        ...
        <input className="form-control rounded-0" type="text" name="location" required />
      </div> */}
